...
public class PublicarRevistaF extends Funcionamiento {
    ...
    private void crearRevista() throws IOException {
        ...
        CostoPorDiaDAO daoCostoPorDia = new CostoPorDiaDAO();
        double costoPorDiaGlobal = daoCostoPorDia.obtenerCostoPorDiaGlobal();
        daoCostoPorDia.asignarCostoPorDiaRevista(idRevista, costoPorDiaGlobal);
        new DetalleCostoPorDiaDAO().agregarPrimerDetalle(idRevista);
